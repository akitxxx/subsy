...
export function LineSignInButton() {
  ...
  return (
    <form action={handleClick} className="flex w-full justify-center">
      <button
        type="submit"
        className="w-full px-3 rounded-[4px] bg-[#06C755] font-semibold text-white shadow-sm transition-all hover:shadow hover:brightness-[0.98]"
      >
        <div className="relative flex h-full w-full items-center">
          <div className="flex h-full w-[40px] items-center justify-center">
            <svg className="h-[40px] w-[40px]" viewBox="0 0 48 48" aria-hidden="true" role="img" aria-labelledby="lineLogoTitle">
              <title id="lineLogoTitle">LINE Logo</title>
              <path
                fill="#ffffff"
          ...
          <span className="flex-1 pl-1 pr-4">LINEでログイン</span>
        </div>
      </button>
    </form>
  );
